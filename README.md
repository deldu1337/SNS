...
### PART 3. 화면 구성 및 세부 기능
 ...
 - 내 프로필 클릭 시, 팔로잉 목록에 '팔로우' 버튼 클릭한 계정 닉네임 표시
 -----------------------
 #### 팔로우 취소
 1.
